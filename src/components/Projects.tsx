  ...
  return (
    <section id="projects" className="projects">
      ...
      <div className="project">
        ...
        <a href="https://github.com/yourusername/project-repo" target="_blank" rel="noopener noreferrer">GitHubで確認</a>
      </div>
      ...
      <div className="project">
        ...
        <a href="https://github.com/yourusername/todo-app" target="_blank" rel="noopener noreferrer">GitHubで確認</a>
      </div>
    </section>
  );
};
